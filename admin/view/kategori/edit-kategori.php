                                            ...
                                            <?php
                                                if(isset($_POST['editBtn'])){
                                                    ...
                                                    if($data['nama']==$kategori){
                                                        ?>
                                                        <meta http-equiv="refresh" content='0; url=kategori.php?halaman=kategori'/>
                                                        <?php
                                                    } else{
                                                        ...
                                                        if($jumlahData>0){
                                                            ?>
                                                        <div class="alert alert-warning mt-3" role="alert">Kategori Telah Tersedia</div>
                                                        <?php
                                                        } else {
                                                            $querySimpan = mysqli_query($koneksi, "UPDATE kategori SET nama='$kategori' WHERE id='$id'");
                                                            if($querySimpan){
                                                                ?>
                                                                 <div class='alert alert-primary mt-3' role="alert">Kategori Diupdate<div>

                                                                 <meta http-equiv="refresh" content='1; url=kategori.php?halaman=kategori'/>
                                                                 <?php
                                                            } else{
